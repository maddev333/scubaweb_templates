...
Connect-AzAccount -TenantId "acd44dbb-b6b6-4134-82dd-0e2f233a6a1d"
...
Add-GraphApiRoleToMSI -ApplicationName "scubarunbook" -GraphApiRole $roles -Token $token.Token
#endregion